# # # // داخل مكون الرياكت (React Component)
# # # <iframe 
# # #   src="http://your-api-url/final_zukhruf25_preview.html" 
# # #   width="100%" 
# # #   height="500px" 
# # #   style={{ border: 'none' }}
# # # />
...
# # def generate_gcode_simulation_html(gcode_text, output_html_path="simulation.html"):
# #     """
# #     Parses G-code text and creates a fast, interactive 3D simulation plot.
# #     Features sequential 4-color gradient (Yellow -> Orange -> Red -> Purple)
# #     with clean customized Hover Tooltips for each motion step.
# #     """
# #     x_coords, y_coords, z_coords = [0.0], [0.0], [0.0]
# #     hover_texts = ["<b>Point:</b> #0<br><b>Cmd:</b> START<br><b>X:</b> 0.0 | <b>Y:</b> 0.0 | <b>Z:</b> 0.0"]
...
# #             # نص مخصص ومختصر للـ Hover لكل نقطة
...
# #     # التدرج بـ 4 ألوان: أصفر -> برتقالي -> أحمر -> بنفسجي
# #     custom_colorscale = [
...
# #     # Trace المسار الأساسي مع التدرج وتوليد الـ Hover Custom Text
...
# #         name="Toolpath",
# #         text=hover_texts,
# #         hoverinfo="text",  # يعرض فقط النص المخصص بأسلوب أنيق
# #         line=dict(
# #             color=step_indices,
...
# #                 ],
# #                 ticktext=["Start (0%)", "33%", "66%", "End (100%)"],
# #                 len=0.35,   # شريط صغير وأنيق
# #                 x=0.01,     # أعلى اليسار
# #                 y=0.98,
# #                 xanchor="left",
# #                 yanchor="top",
...
# #     print(f"[Simulation] Interactive 3D preview saved to: {output_html_path}")
...
#     Returns a list of points EXCLUDING the start point (which is already
#     in the path) and INCLUDING the end point.
#     """
...
# def generate_gcode_simulation_html(gcode_text, output_html_path=DEFAULT_SIM_PATH):
#     """
#     Parses G-code text and creates a fast, interactive 3D simulation plot.
#     Features sequential 4-color gradient (Yellow -> Orange -> Red -> Purple),
#     accurate arc (G2/G3) rendering, clean Hover Tooltips, and colored
